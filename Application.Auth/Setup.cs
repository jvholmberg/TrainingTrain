...
namespace Application.Auth
{
	public static class Setup
	{
		...
		public static void SetupApplicationAuth(this IServiceCollection services, string connectionString)
		{
		...
		public static void SetupApplicationAuth(this IApplicationBuilder app)
		{
